...
function getDetail(id, categoryid) {
	...
	$.loadData('/api/100/500/50', '{"categoryId": "' + categoryid + '","id":"' + id + '"}', function(data) {
		...
		$msg = $('<div class="banner">' +
			...
			'<div class="info-box">' +
			'<ul>' +
			'<li><span class="title">许可证号：</span><span id="status">' + data.no + '</span></li>' +
			'<li><span class="title">邮政编码：</span><span id="mechanism">' + data.zipCode + '</span></li>' +
			...
			'<li><span class="title">业务范围：</span><span id="expertise">' + data.scopeOfBussess + '</span></li>' +
			'<li class="w90"><span class="title">联系地址：</span><span id="status">' + data.agencyAddress + '</span></li>' +
