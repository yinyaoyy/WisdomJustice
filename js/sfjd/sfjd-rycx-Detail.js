...
function getDetail(id, categoryid) {
	$.loadData('/api/100/500/50', '{"categoryId": "' + categoryid + '","id":"' + id + '"}', function(data) {
		...
		$msg = $('<div class="banner">' +
			...
			'<div class="info-box">' +
			'<ul>' +
			'<li><span class="title">学历：</span><span id="status">' + data.education + '</span></li>' +
			'<li><span class="title">执业证号：</span><span id="status">' + data.no + '</span></li>' +
			'<li><span class="title">执业范围：</span><span id="status">' + data.scopeOfBussess + '</span></li>' +
			'<li><span class="title">蒙汉双通：</span><span id="mechanism">' + data.isMongolian + '</span></li>' +
			
			'<li><span class="title">执业年限：</span><span id="expertise">' + data.practisingYear + '</span></li>' +
			'<li class="w90"><span class="title">执业机构：</span><span id="status">' + data.agencyName + '</span></li>' +
