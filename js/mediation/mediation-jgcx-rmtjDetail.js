...
function getDetail(id, categoryid) {
	...
	$.loadData('/api/100/500/50', '{"categoryId": "' + categoryid + '","id":"' + id + '"}', function(data) {
		...
		$msg = $('<div class="banner">' +
			...
			'<ul>' +
			'<li><span class="title">负责人：</span><span id="nation">' + data.personName + '</span></li>' +
			'<li><span class="title">所属地区：</span><span id="outlook">' + data.town.name + '</span></li>' +
			'</ul>' +
			'</div>' +
			'</div>' +
			...
			'<li class="adr"><span class="title">机构地址：</span><span id="expertise">' + data.agencyAddress + '</span></li>' +
			'<li><span class="title">成立时间：</span><span>' + data.birthday + '</span></li>' +
			'<li class="intro"><span class="title">机构简介：</span><span id="introduce" class="introduce">' + data.introduction + '</span></li>' +
			'</ul>' +
			'</div>' +
