...
function getDetail(id, categoryid) {
	...
	$.loadData('/api/100/500/50', '{"categoryId": "' + categoryid + '","id":"' + id + '"}', function(data) {
		...
		$msg = $('<div class="banner">' +
			...
			'<ul>' +
			'<li><span class="title">所长：</span><span id="nation">' + data.personName + '</span></li>' +
			'<li><span class="title">所属地区：</span><span id="outlook">' + data.area.name + '</span></li>' +
			'</ul>' +
			'</div>' +
			'</div>' +
			...
			'<div class="info-box">' +
			'<ul>' +
			'<li><span class="title">邮政编码：</span><span>' + data.zipCode + '</span></li>' +
			'<li><span class="title">机构证号：</span><span>' + data.no + '</span></li>' +
			'<li><span class="title">组织形式：</span><span id="status">' + data.licenseForm + '</span></li>' +
			'<li class="w90"><span class="title">业务专长：</span><span>' + data.businessExpertise + '</span></li>' +
			'<li class="adr"><span class="title">机构地址：</span><span id="orgAdress">' + data.agencyAddress + '</span></li><br/>' +
			'<li class="intro"><span class="title">基层法律服务所简介：</span><span id="introduce" class="introduce">' + data.introduction + '</span></li>' +
			'</ul>' +
			'</div>' +
