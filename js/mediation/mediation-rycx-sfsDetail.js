...
function getDetail(id, categoryid) {
	...
	$.loadData('/api/100/500/50', '{"categoryId": "' + categoryid + '","id":"' + id + '"}', function(data) {
		...
		$msg = $('<div class="banner">' +
			...
			'<div class="info-box">' +
			'<ul>' +
			'<li><span class="title">职务：</span><span id="status">' + data.roleId + '</span></li>' +
			'<li><span class="title">所属机构：</span><span id="expertise">' + data.agencyName + '</span></li>' +
			'<li><span class="title">所属地区：</span><span id="status">' + data.area.name + '</span></li>' +
