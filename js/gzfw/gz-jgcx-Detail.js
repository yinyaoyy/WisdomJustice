...
function getDetail(id, categoryid) {
	...
	$.loadData('/api/100/500/50', '{"categoryId": "' + categoryid + '","id":"' + id + '"}', function(data) {
		...
		$msg = $('<div class="banner">' +
			...
			'<li><span class="title">服务时间：</span><span id="expertise">' + data.worktime + '</span></li>' +
			'<li><span class="title">业务专长：</span><span id="mechanism">' + data.businessExpertise + '</span></li>' +
			'<li><span class="title">团队规模：</span><span id="status">' + data.teamSize + '</span></li>' +
			'<li><span class="title">职业年限：</span><span id="status">' + data.practisingYear + '</span></li>' +
			'<li><span class="title">主管机关：</span><span id="expertise">' + data.mainOrgans + '</span></li>' +
			'<li><span class="title">传真号码：</span><span id="status">' + data.fax + '</span></li>' +
			'<li><span class="title">机构地址：</span><span id="status">' + data.agencyAddress + '</span></li>' +
			'<li><span class="title">邮政编码：</span><span id="expertise">' + data.zipCode + '</span></li>' +
