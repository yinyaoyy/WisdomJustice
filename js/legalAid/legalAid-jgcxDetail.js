...
function getDetail(id, categoryid) {
	...
	$.loadData('/api/100/500/50', '{"categoryId": "' + categoryid + '","id":"' + id + '"}', function(data) {
		...
		$msg = $('<div class="banner">' +
			...
			'<li><span class="title">人员数量：</span><span id="expertise">' + data.teamSize + '</span></li>' +
			'<li class="w90"><span class="title">办公时间：</span><span id="status">' + data.worktime + '</span></li>' +
			
			'<li class="adr"><span class="title">机构地址：</span><span id="mechanism">' + data.agencyAddress + '</span></li>' +
...
function renderMarker(name, coord) {
	console.log(coord)
//	var defaultPoint = new BMap.Point(116.093697,43.932341)
//	var c = new BMap.Point(point[0], point[1]);
